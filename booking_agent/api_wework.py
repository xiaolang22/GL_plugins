...
def get_fields(access_token: str, docid: str, sheet_id: str, offset: int = 0, limit: int = 100) -> Dict[str, Any]:
    """查询字段"""
...
def delete_fields(access_token: str, docid: str, sheet_id: str, field_ids: List[str]) -> Dict[str, Any]:
    """删除字段"""
...
def update_fields(access_token: str, docid: str, sheet_id: str, fields: List[Dict]) -> Dict[str, Any]:
...
def get_views(access_token: str, docid: str, sheet_id: str, offset: int = 0, limit: int = 100) -> Dict[str, Any]:
    """查询视图"""
...
def update_view(access_token: str, docid: str, sheet_id: str, view_id: str, property: Dict) -> Dict[str, Any]:
